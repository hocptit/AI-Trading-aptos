...
Aptos is a new, scalable blockchain that aims to provide high throughput and low latency. This project leverages the Aptos SDK to interact with the Aptos blockchain, making it easier to build decentralized applications (dApps) on Aptos.
